...
2. **Section:** Method — the closing "technology should feel human" beat
...
11. **Color palette:** Warm neutrals matching the section's graphite→warm-white transition
...
2. **Section:** Expertise / Web Expansion (the "ACTION." → "Todo un mundo digital." scene)
...
- No other section needs new photography. Hero, Intelligence, Why It
  Matters, and Contact are typographic/3D/gradient compositions by design.
